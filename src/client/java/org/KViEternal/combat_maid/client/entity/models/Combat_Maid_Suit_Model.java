...
public class Combat_Maid_Suit_Model extends Model<net.minecraft.client.render.entity.state.BipedEntityRenderState> {
	...
	public Combat_Maid_Suit_Model(ModelPart root) {
		super(root, RenderLayers::armorCutoutNoCull);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Body = modelPartData.addChild("Body", ModelPartBuilder.create().uv(16, 26).cuboid(-4.0F, 9.7F, -2.0F, 8.0F, 1.0F, 4.0F, new Dilation(0.06F))
				...
				.uv(2, 44).cuboid(-4.0F, 0.0F, -2.0F, 8.0F, 9.0F, 4.0F, new Dilation(0.2F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData Chest = Body.addChild("Chest", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 1.5F, -1.0F));
		...
		ModelPartData Skirt = modelPartData.addChild("Skirt", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 1.0F, 0.0F));

		ModelPartData Sides = Skirt.addChild("Sides", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 8.0F, 0.0F));
		...
		ModelPartData Back = Skirt.addChild("Back", ModelPartBuilder.create(), ModelTransform.origin(-5.0F, 8.0F, 1.75F));
		...
		ModelPartData Front = Skirt.addChild("Front", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 8.0F, -1.75F));
		...
		ModelPartData RightArm = modelPartData.addChild("RightArm", ModelPartBuilder.create().uv(40, 16).cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-5.0F, 2.0F, 0.0F));

		ModelPartData LeftArm = modelPartData.addChild("LeftArm", ModelPartBuilder.create().uv(32, 48).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(5.0F, 2.0F, 0.0F));

		return TexturedModelData.of(modelData, 64, 64);
	}

	public void renderBody(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, int color) {
